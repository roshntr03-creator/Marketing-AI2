...
const HistoryItemSkeleton: React.FC = () => {
    return (
        <div className="w-full text-left p-4 rounded-lg border flex items-center space-x-4 rtl:space-x-reverse bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 animate-pulse">
